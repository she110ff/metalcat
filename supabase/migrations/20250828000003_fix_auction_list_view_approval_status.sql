-- ============================================
-- auction_list_view에 approval_status 컬럼 추가
-- 생성일: 2025-08-28
-- 목적: 관리자 대시보드에서 승인 상태별 경매 조회 지원
-- ============================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ auction_list_view에 approval_status 컬럼 추가 완료!';
  RAISE NOTICE '   📊 새로 추가된 컬럼들:';
  RAISE NOTICE '      - approval_status: 승인 상태';
  RAISE NOTICE '      - approved_at: 승인 시간';
  RAISE NOTICE '      - approved_by: 승인자 ID';
  RAISE NOTICE '      - rejection_reason: 거부 사유';
END $$;
